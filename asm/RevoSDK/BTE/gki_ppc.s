...
/* 800DB178 000D6698  3B FE 3C A0 */	addi r31, r30, 0x3ca0
...
/* 800DB198 000D66B8  98 1E 3C A0 */	stb r0, 0x3ca0(r30)
/* 800DB19C 000D66BC  4B FB A1 2D */	bl OSEnableInterrupts
/* 800DB1A0 000D66C0  88 1E 3C A0 */	lbz r0, 0x3ca0(r30)
...
/* 800DB1B0 000D66D0  88 7E 3C A0 */	lbz r3, 0x3ca0(r30)
/* 800DB1B4 000D66D4  38 03 00 01 */	addi r0, r3, 1
/* 800DB1B8 000D66D8  98 1E 3C A0 */	stb r0, 0x3ca0(r30)
...
/* 800DB1F8 000D6718  3B FE 3C A0 */	addi r31, r30, 0x3ca0
...
/* 800DB20C 000D672C  88 7E 3C A0 */	lbz r3, 0x3ca0(r30)
/* 800DB210 000D6730  38 63 00 01 */	addi r3, r3, 1
/* 800DB214 000D6734  98 7E 3C A0 */	stb r3, 0x3ca0(r30)
/* 800DB218 000D6738  98 04 88 02 */	stb r0, -0x77fe(r4)
/* 800DB21C 000D673C  88 7E 3C A0 */	lbz r3, 0x3ca0(r30)
/* 800DB220 000D6740  38 63 FF FF */	addi r3, r3, -1
/* 800DB224 000D6744  54 60 15 BA */	rlwinm r0, r3, 2, 0x16, 0x1d
/* 800DB228 000D6748  98 7E 3C A0 */	stb r3, 0x3ca0(r30)
...
/* 800DB238 000D6758  48 00 00 20 */	b lbl_800DB258
lbl_800DB23C:
/* 800DB23C 000D675C  88 7E 3C A0 */	lbz r3, 0x3ca0(r30)
/* 800DB240 000D6760  38 63 FF FF */	addi r3, r3, -1
/* 800DB244 000D6764  54 60 15 BA */	rlwinm r0, r3, 2, 0x16, 0x1d
/* 800DB248 000D6768  98 7E 3C A0 */	stb r3, 0x3ca0(r30)
...
lbl_800DB258:
/* 800DB258 000D6778  88 1E 3C A0 */	lbz r0, 0x3ca0(r30)
/* 800DB25C 000D677C  2C 00 00 00 */	cmpwi r0, 0
/* 800DB260 000D6780  40 82 FF DC */	bne lbl_800DB23C
...
/* 800DB2AC 000D67CC  41 80 00 0C */	blt lbl_800DB2B8
/* 800DB2B0 000D67D0  38 60 00 01 */	li r3, 1
/* 800DB2B4 000D67D4  48 00 00 64 */	b lbl_800DB318
lbl_800DB2B8:
...
/* 800DB2C8 000D67E8  38 C7 3C A0 */	addi r6, r7, 0x3ca0
...
/* 800DB2E0 000D6800  88 67 3C A0 */	lbz r3, 0x3ca0(r7)
/* 800DB2E4 000D6804  38 03 00 01 */	addi r0, r3, 1
/* 800DB2E8 000D6808  98 07 3C A0 */	stb r0, 0x3ca0(r7)
...
/* 800DB374 000D6894  38 85 3C A0 */	addi r4, r5, 0x3ca0
...
/* 800DB384 000D68A4  88 65 3C A0 */	lbz r3, 0x3ca0(r5)
/* 800DB388 000D68A8  38 03 00 01 */	addi r0, r3, 1
/* 800DB38C 000D68AC  98 05 3C A0 */	stb r0, 0x3ca0(r5)
...
/* 800DB3B8 000D68D8  40 82 00 08 */	bne lbl_800DB3C0
...
/* 800DB3D8 000D68F8  41 82 00 14 */	beq lbl_800DB3EC
