...
/* 800DB41C 000D693C  41 82 00 0C */	beq lbl_800DB428
/* 800DB420 000D6940  38 60 00 00 */	li r3, 0
/* 800DB424 000D6944  48 00 03 54 */	b lbl_800DB778
lbl_800DB428:
...
/* 800DB45C 000D697C  3D C0 80 1A */	lis r14, 0x801a
...
/* 800DB47C 000D699C  41 82 02 F8 */	beq lbl_800DB774
...
/* 800DB490 000D69B0  41 82 01 C8 */	beq lbl_800DB658
/* 800DB494 000D69B4  40 80 00 14 */	bge lbl_800DB4A8
/* 800DB498 000D69B8  2C 00 00 00 */	cmpwi r0, 0
/* 800DB49C 000D69BC  41 82 00 1C */	beq lbl_800DB4B8
/* 800DB4A0 000D69C0  40 80 00 C0 */	bge lbl_800DB560
/* 800DB4A4 000D69C4  48 00 02 B0 */	b lbl_800DB754
lbl_800DB4A8:
/* 800DB4A8 000D69C8  2C 00 00 04 */	cmpwi r0, 4
/* 800DB4AC 000D69CC  41 82 02 90 */	beq lbl_800DB73C
/* 800DB4B0 000D69D0  40 80 02 A4 */	bge lbl_800DB754
/* 800DB4B4 000D69D4  48 00 01 F0 */	b lbl_800DB6A4
lbl_800DB4B8:
/* 800DB4B8 000D69D8  28 10 00 01 */	cmplwi r16, 1
/* 800DB4BC 000D69DC  40 82 00 18 */	bne lbl_800DB4D4
...
/* 800DB4D0 000D69F0  48 00 00 38 */	b lbl_800DB508
lbl_800DB4D4:
/* 800DB4D4 000D69F4  28 10 00 02 */	cmplwi r16, 2
/* 800DB4D8 000D69F8  40 82 00 18 */	bne lbl_800DB4F0
...
/* 800DB4EC 000D6A0C  48 00 00 1C */	b lbl_800DB508
lbl_800DB4F0:
/* 800DB4F0 000D6A10  28 10 00 03 */	cmplwi r16, 3
/* 800DB4F4 000D6A14  40 82 02 60 */	bne lbl_800DB754
...
/* 800DB510 000D6A30  41 82 00 30 */	beq lbl_800DB540
...
/* 800DB53C 000D6A5C  48 00 00 14 */	b lbl_800DB550
lbl_800DB540:
/* 800DB540 000D6A60  38 8E A3 70 */	addi r4, r14, -23696
...
/* 800DB58C 000D6AAC  40 82 00 C0 */	bne lbl_800DB64C
...
/* 800DB59C 000D6ABC  40 82 00 44 */	bne lbl_800DB5E0
...
/* 800DB5C0 000D6AE0  40 82 00 20 */	bne lbl_800DB5E0
/* 800DB5C4 000D6AE4  2C 12 00 00 */	cmpwi r18, 0
/* 800DB5C8 000D6AE8  B2 55 00 0C */	sth r18, 0xc(r21)
/* 800DB5CC 000D6AEC  40 82 00 0C */	bne lbl_800DB5D8
/* 800DB5D0 000D6AF0  9B B6 00 1A */	stb r29, 0x1a(r22)
/* 800DB5D4 000D6AF4  48 00 01 80 */	b lbl_800DB754
lbl_800DB5D8:
/* 800DB5D8 000D6AF8  9B D6 00 1A */	stb r30, 0x1a(r22)
/* 800DB5DC 000D6AFC  48 00 01 78 */	b lbl_800DB754
lbl_800DB5E0:
...
/* 800DB608 000D6B28  40 81 00 28 */	ble lbl_800DB630
...
/* 800DB668 000D6B88  40 82 00 30 */	bne lbl_800DB698
...
/* 800DB678 000D6B98  40 82 00 14 */	bne lbl_800DB68C
...
/* 800DB694 000D6BB4  48 00 00 C0 */	b lbl_800DB754
lbl_800DB698:
/* 800DB698 000D6BB8  88 01 00 08 */	lbz r0, 8(r1)
/* 800DB69C 000D6BBC  98 16 00 17 */	stb r0, 0x17(r22)
/* 800DB6A0 000D6BC0  48 00 00 B4 */	b lbl_800DB754
lbl_800DB6A4:
...
/* 800DB74C 000D6C6C  40 82 00 08 */	bne lbl_800DB754
/* 800DB750 000D6C70  9B B6 00 1A */	stb r29, 0x1a(r22)
lbl_800DB754:
/* 800DB754 000D6C74  2C 11 00 00 */	cmpwi r17, 0
/* 800DB758 000D6C78  41 82 FD 10 */	beq lbl_800DB468
...
/* 800DB770 000D6C90  4B FF FC F8 */	b lbl_800DB468
lbl_800DB774:
...
/* 800DB7BC 000D6CDC  40 82 00 0C */	bne lbl_800DB7C8
/* 800DB7C0 000D6CE0  3B 80 00 02 */	li r28, 2
/* 800DB7C4 000D6CE4  48 00 00 20 */	b lbl_800DB7E4
lbl_800DB7C8:
/* 800DB7C8 000D6CE8  28 05 22 00 */	cmplwi r5, 0x2200
/* 800DB7CC 000D6CEC  40 82 00 0C */	bne lbl_800DB7D8
/* 800DB7D0 000D6CF0  3B 80 00 03 */	li r28, 3
/* 800DB7D4 000D6CF4  48 00 00 10 */	b lbl_800DB7E4
lbl_800DB7D8:
/* 800DB7D8 000D6CF8  28 05 20 00 */	cmplwi r5, 0x2000
/* 800DB7DC 000D6CFC  40 82 00 08 */	bne lbl_800DB7E4
/* 800DB7E0 000D6D00  3B 80 00 00 */	li r28, 0
lbl_800DB7E4:
/* 800DB7E4 000D6D04  28 05 21 00 */	cmplwi r5, 0x2100
/* 800DB7E8 000D6D08  40 82 01 20 */	bne lbl_800DB908
...
/* 800DB800 000D6D20  40 81 01 08 */	ble lbl_800DB908
...
/* 800DB828 000D6D48  48 00 00 D0 */	b lbl_800DB8F8
lbl_800DB82C:
...
/* 800DB87C 000D6D9C  40 81 00 20 */	ble lbl_800DB89C
...
/* 800DB898 000D6DB8  48 00 00 20 */	b lbl_800DB8B8
lbl_800DB89C:
...
/* 800DB8C0 000D6DE0  41 82 00 38 */	beq lbl_800DB8F8
...
/* 800DB8D0 000D6DF0  40 82 00 28 */	bne lbl_800DB8F8
...
/* 800DB8F4 000D6E14  48 00 00 30 */	b lbl_800DB924
lbl_800DB8F8:
...
/* 800DB904 000D6E24  41 81 FF 28 */	bgt lbl_800DB82C
lbl_800DB908:
