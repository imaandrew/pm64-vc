...
/* 800AA488 000A59A8  40 82 00 48 */	bne lbl_800AA4D0
...
/* 800AA498 000A59B8  40 82 00 1C */	bne lbl_800AA4B4
...
/* 800AA4B0 000A59D0  4B FF FF 9C */	b lbl_800AA44C
lbl_800AA4B4:
/* 800AA4B4 000A59D4  2C 00 00 00 */	cmpwi r0, 0
/* 800AA4B8 000A59D8  40 82 00 38 */	bne lbl_800AA4F0
...
/* 800AA59C 000A5ABC  48 00 00 24 */	b lbl_800AA5C0
lbl_800AA5A0:
/* 800AA5A0 000A5AC0  7F 58 D3 78 */	mr r24, r26
/* 800AA5A4 000A5AC4  48 00 00 08 */	b lbl_800AA5AC
lbl_800AA5A8:
...
/* 800AA5B4 000A5AD4  41 82 00 0C */	beq lbl_800AA5C0
/* 800AA5B8 000A5AD8  2C 00 00 2F */	cmpwi r0, 0x2f
/* 800AA5BC 000A5ADC  40 82 FF EC */	bne lbl_800AA5A8
lbl_800AA5C0:
...
/* 800AA5F4 000A5B14  48 00 00 F0 */	b lbl_800AA6E4
lbl_800AA5F8:
...
/* 800AA604 000A5B24  40 82 00 0C */	bne lbl_800AA610
/* 800AA608 000A5B28  2C 00 00 01 */	cmpwi r0, 1
/* 800AA60C 000A5B2C  41 82 00 C4 */	beq lbl_800AA6D0
lbl_800AA610:
...
/* 800AA61C 000A5B3C  48 00 00 7C */	b lbl_800AA698
lbl_800AA620:
...
/* 800AA630 000A5B50  41 80 00 0C */	blt lbl_800AA63C
/* 800AA634 000A5B54  2C 18 01 00 */	cmpwi r24, 0x100
/* 800AA638 000A5B58  41 80 00 08 */	blt lbl_800AA640
lbl_800AA63C:
/* 800AA63C 000A5B5C  39 40 00 01 */	li r10, 1
lbl_800AA640:
/* 800AA640 000A5B60  2C 0A 00 00 */	cmpwi r10, 0
/* 800AA644 000A5B64  41 82 00 08 */	beq lbl_800AA64C
/* 800AA648 000A5B68  48 00 00 0C */	b lbl_800AA654
lbl_800AA64C:
...
/* 800AA664 000A5B84  41 80 00 0C */	blt lbl_800AA670
/* 800AA668 000A5B88  2C 0B 01 00 */	cmpwi r11, 0x100
/* 800AA66C 000A5B8C  41 80 00 08 */	blt lbl_800AA674
lbl_800AA670:
/* 800AA670 000A5B90  39 40 00 01 */	li r10, 1
lbl_800AA674:
/* 800AA674 000A5B94  2C 0A 00 00 */	cmpwi r10, 0
/* 800AA678 000A5B98  41 82 00 08 */	beq lbl_800AA680
/* 800AA67C 000A5B9C  48 00 00 0C */	b lbl_800AA688
lbl_800AA680:
...
/* 800AA68C 000A5BAC  41 82 00 0C */	beq lbl_800AA698
/* 800AA690 000A5BB0  39 40 00 00 */	li r10, 0
/* 800AA694 000A5BB4  48 00 00 34 */	b lbl_800AA6C8
lbl_800AA698:
/* 800AA698 000A5BB8  89 59 00 00 */	lbz r10, 0(r25)
/* 800AA69C 000A5BBC  7D 4A 07 75 */	extsb. r10, r10
/* 800AA6A0 000A5BC0  40 82 FF 80 */	bne lbl_800AA620
...
/* 800AA6B0 000A5BD0  41 82 00 0C */	beq lbl_800AA6BC
/* 800AA6B4 000A5BD4  2C 0A 00 00 */	cmpwi r10, 0
/* 800AA6B8 000A5BD8  40 82 00 0C */	bne lbl_800AA6C4
lbl_800AA6BC:
/* 800AA6BC 000A5BDC  39 40 00 01 */	li r10, 1
/* 800AA6C0 000A5BE0  48 00 00 08 */	b lbl_800AA6C8
lbl_800AA6C4:
/* 800AA6C4 000A5BE4  39 40 00 00 */	li r10, 0
lbl_800AA6C8:
/* 800AA6C8 000A5BE8  2C 0A 00 01 */	cmpwi r10, 1
/* 800AA6CC 000A5BEC  41 82 00 28 */	beq lbl_800AA6F4
lbl_800AA6D0:
/* 800AA6D0 000A5BF0  2C 07 00 00 */	cmpwi r7, 0
/* 800AA6D4 000A5BF4  41 82 00 0C */	beq lbl_800AA6E0
/* 800AA6D8 000A5BF8  80 66 00 08 */	lwz r3, 8(r6)
/* 800AA6DC 000A5BFC  48 00 00 08 */	b lbl_800AA6E4
lbl_800AA6E0:
/* 800AA6E0 000A5C00  38 63 00 01 */	addi r3, r3, 1
lbl_800AA6E4:
/* 800AA6E4 000A5C04  7C 03 28 40 */	cmplw r3, r5
/* 800AA6E8 000A5C08  41 80 FF 10 */	blt lbl_800AA5F8
/* 800AA6EC 000A5C0C  38 60 FF FF */	li r3, -1
/* 800AA6F0 000A5C10  48 00 00 20 */	b lbl_800AA710
lbl_800AA6F4:
/* 800AA6F4 000A5C14  2C 00 00 00 */	cmpwi r0, 0
/* 800AA6F8 000A5C18  40 82 00 08 */	bne lbl_800AA700
/* 800AA6FC 000A5C1C  48 00 00 14 */	b lbl_800AA710
lbl_800AA700:
...
/* 800AA70C 000A5C2C  4B FF FD 40 */	b lbl_800AA44C
lbl_800AA710:
...
/* 800AA76C 000A5C8C  41 82 00 0C */	beq lbl_800AA778
lbl_800AA770:
...
/* 800AA7F4 000A5D14  40 82 00 0C */	bne lbl_800AA800
/* 800AA7F8 000A5D18  38 60 00 00 */	li r3, 0
/* 800AA7FC 000A5D1C  48 00 01 80 */	b lbl_800AA97C
lbl_800AA800:
...
/* 800AA824 000A5D44  40 82 00 0C */	bne lbl_800AA830
/* 800AA828 000A5D48  38 80 00 00 */	li r4, 0
/* 800AA82C 000A5D4C  48 00 00 F4 */	b lbl_800AA920
lbl_800AA830:
...
/* 800AA848 000A5D68  40 82 00 0C */	bne lbl_800AA854
/* 800AA84C 000A5D6C  38 80 00 00 */	li r4, 0
/* 800AA850 000A5D70  48 00 00 78 */	b lbl_800AA8C8
lbl_800AA854:
...
/* 800AA874 000A5D94  40 82 00 08 */	bne lbl_800AA87C
/* 800AA878 000A5D98  48 00 00 50 */	b lbl_800AA8C8
lbl_800AA87C:
...
/* 800AA894 000A5DB4  48 00 00 18 */	b lbl_800AA8AC
lbl_800AA898:
...
/* 800AA8B0 000A5DD0  41 82 00 10 */	beq lbl_800AA8C0
/* 800AA8B4 000A5DD4  88 1B 00 00 */	lbz r0, 0(r27)
/* 800AA8B8 000A5DD8  7C 00 07 75 */	extsb. r0, r0
/* 800AA8BC 000A5DDC  40 82 FF DC */	bne lbl_800AA898
lbl_800AA8C0:
...
/* 800AA8CC 000A5DEC  40 82 00 08 */	bne lbl_800AA8D4
/* 800AA8D0 000A5DF0  48 00 00 50 */	b lbl_800AA920
lbl_800AA8D4:
...
/* 800AA8EC 000A5E0C  48 00 00 18 */	b lbl_800AA904
lbl_800AA8F0:
...
/* 800AA908 000A5E28  41 82 00 10 */	beq lbl_800AA918
/* 800AA90C 000A5E2C  88 1F 00 00 */	lbz r0, 0(r31)
/* 800AA910 000A5E30  7C 00 07 75 */	extsb. r0, r0
/* 800AA914 000A5E34  40 82 FF DC */	bne lbl_800AA8F0
lbl_800AA918:
...
/* 800AA924 000A5E44  40 82 00 0C */	bne lbl_800AA930
/* 800AA928 000A5E48  7C 83 23 78 */	mr r3, r4
/* 800AA92C 000A5E4C  48 00 00 50 */	b lbl_800AA97C
lbl_800AA930:
...
/* 800AA948 000A5E68  48 00 00 18 */	b lbl_800AA960
lbl_800AA94C:
...
/* 800AA964 000A5E84  41 82 00 10 */	beq lbl_800AA974
/* 800AA968 000A5E88  88 1E 00 00 */	lbz r0, 0(r30)
/* 800AA96C 000A5E8C  7C 00 07 75 */	extsb. r0, r0
/* 800AA970 000A5E90  40 82 FF DC */	bne lbl_800AA94C
lbl_800AA974:
...
/* 800AA9C4 000A5EE4  41 80 00 10 */	blt lbl_800AA9D4
/* 800AA9C8 000A5EE8  80 03 00 34 */	lwz r0, 0x34(r3)
/* 800AA9CC 000A5EEC  7C 06 00 40 */	cmplw r6, r0
/* 800AA9D0 000A5EF0  40 81 00 1C */	ble lbl_800AA9EC
lbl_800AA9D4:
...
/* 800AA9F0 000A5F10  41 80 00 14 */	blt lbl_800AAA04
...
/* 800AAA00 000A5F20  41 80 00 1C */	blt lbl_800AAA1C
lbl_800AAA04:
...
/* 800AAA24 000A5F44  3C E0 80 0B */	lis r7, lbl_800AAA64@ha
...
/* 800AAA40 000A5F60  38 E7 AA 64 */	addi r7, r7, lbl_800AAA64@l
...
/* 800AAAA8 000A5FC8  41 80 00 10 */	blt lbl_800AAAB8
/* 800AAAAC 000A5FCC  80 03 00 34 */	lwz r0, 0x34(r3)
/* 800AAAB0 000A5FD0  7C 06 00 40 */	cmplw r6, r0
/* 800AAAB4 000A5FD4  40 81 00 1C */	ble lbl_800AAAD0
lbl_800AAAB8:
...
/* 800AAAD4 000A5FF4  41 80 00 14 */	blt lbl_800AAAE8
...
/* 800AAAE4 000A6004  41 80 00 1C */	blt lbl_800AAB00
lbl_800AAAE8:
...
/* 800AAB08 000A6028  3C E0 80 0B */	lis r7, lbl_800AABA4@ha
...
/* 800AAB20 000A6040  38 E7 AB A4 */	addi r7, r7, lbl_800AABA4@l
/* 800AAB24 000A6044  48 00 3D 9D */	bl DVDReadAbsAsyncPrio
/* 800AAB28 000A6048  2C 03 00 00 */	cmpwi r3, 0
/* 800AAB2C 000A604C  40 82 00 0C */	bne lbl_800AAB38
/* 800AAB30 000A6050  38 60 FF FF */	li r3, -1
/* 800AAB34 000A6054  48 00 00 58 */	b lbl_800AAB8C
lbl_800AAB38:
...
/* 800AAB48 000A6068  40 82 00 0C */	bne lbl_800AAB54
/* 800AAB4C 000A606C  83 DB 00 20 */	lwz r30, 0x20(r27)
/* 800AAB50 000A6070  48 00 00 30 */	b lbl_800AAB80
lbl_800AAB54:
/* 800AAB54 000A6074  2C 00 FF FF */	cmpwi r0, -1
/* 800AAB58 000A6078  40 82 00 0C */	bne lbl_800AAB64
/* 800AAB5C 000A607C  3B C0 FF FF */	li r30, -1
/* 800AAB60 000A6080  48 00 00 20 */	b lbl_800AAB80
lbl_800AAB64:
/* 800AAB64 000A6084  2C 00 00 0A */	cmpwi r0, 0xa
/* 800AAB68 000A6088  40 82 00 0C */	bne lbl_800AAB74
/* 800AAB6C 000A608C  3B C0 FF FD */	li r30, -3
/* 800AAB70 000A6090  48 00 00 10 */	b lbl_800AAB80
lbl_800AAB74:
/* 800AAB74 000A6094  38 6D 8E F8 */	addi r3, r13, lbl_80247378@sda21
/* 800AAB78 000A6098  4B FE E0 71 */	bl OSSleepThread
/* 800AAB7C 000A609C  4B FF FF C4 */	b lbl_800AAB40
lbl_800AAB80:
...
/* 800AAC0C 000A612C  40 82 00 0C */	bne lbl_800AAC18
/* 800AAC10 000A6130  38 80 00 00 */	li r4, 0
/* 800AAC14 000A6134  48 00 01 04 */	b lbl_800AAD18
lbl_800AAC18:
...
/* 800AAC30 000A6150  40 82 00 0C */	bne lbl_800AAC3C
/* 800AAC34 000A6154  38 80 00 00 */	li r4, 0
/* 800AAC38 000A6158  48 00 00 84 */	b lbl_800AACBC
lbl_800AAC3C:
...
/* 800AAC64 000A6184  40 82 00 08 */	bne lbl_800AAC6C
/* 800AAC68 000A6188  48 00 00 54 */	b lbl_800AACBC
lbl_800AAC6C:
...
/* 800AAC88 000A61A8  48 00 00 18 */	b lbl_800AACA0
lbl_800AAC8C:
...
/* 800AACA4 000A61C4  41 82 00 10 */	beq lbl_800AACB4
/* 800AACA8 000A61C8  88 1B 00 00 */	lbz r0, 0(r27)
/* 800AACAC 000A61CC  7C 00 07 75 */	extsb. r0, r0
/* 800AACB0 000A61D0  40 82 FF DC */	bne lbl_800AAC8C
lbl_800AACB4:
...
/* 800AACC0 000A61E0  40 82 00 08 */	bne lbl_800AACC8
/* 800AACC4 000A61E4  48 00 00 54 */	b lbl_800AAD18
lbl_800AACC8:
...
/* 800AACE4 000A6204  48 00 00 18 */	b lbl_800AACFC
lbl_800AACE8:
...
/* 800AAD00 000A6220  41 82 00 10 */	beq lbl_800AAD10
/* 800AAD04 000A6224  88 1F 00 00 */	lbz r0, 0(r31)
/* 800AAD08 000A6228  7C 00 07 75 */	extsb. r0, r0
/* 800AAD0C 000A622C  40 82 FF DC */	bne lbl_800AACE8
lbl_800AAD10:
...
/* 800AAD1C 000A623C  40 82 00 08 */	bne lbl_800AAD24
/* 800AAD20 000A6240  48 00 00 54 */	b lbl_800AAD74
lbl_800AAD24:
...
/* 800AAD40 000A6260  48 00 00 18 */	b lbl_800AAD58
lbl_800AAD44:
...
/* 800AAD5C 000A627C  41 82 00 10 */	beq lbl_800AAD6C
/* 800AAD60 000A6280  88 1E 00 00 */	lbz r0, 0(r30)
/* 800AAD64 000A6284  7C 00 07 75 */	extsb. r0, r0
/* 800AAD68 000A6288  40 82 FF DC */	bne lbl_800AAD44
lbl_800AAD6C:
...
/* 800AAD78 000A6298  40 82 00 10 */	bne lbl_800AAD88
/* 800AAD7C 000A629C  38 00 00 00 */	li r0, 0
/* 800AAD80 000A62A0  98 01 00 87 */	stb r0, 0x87(r1)
/* 800AAD84 000A62A4  48 00 00 4C */	b lbl_800AADD0
lbl_800AAD88:
...
/* 800AAD98 000A62B8  41 82 00 2C */	beq lbl_800AADC4
/* 800AAD9C 000A62BC  28 04 00 7F */	cmplwi r4, 0x7f
/* 800AADA0 000A62C0  40 82 00 14 */	bne lbl_800AADB4
...
/* 800AADB0 000A62D0  48 00 00 20 */	b lbl_800AADD0
lbl_800AADB4:
...
/* 800AADEC 000A630C  48 00 00 40 */	b lbl_800AAE2C
lbl_800AADF0:
...
/* 800AAE00 000A6320  40 82 00 0C */	bne lbl_800AAE0C
/* 800AAE04 000A6324  38 60 00 00 */	li r3, 0
/* 800AAE08 000A6328  48 00 00 24 */	b lbl_800AAE2C
lbl_800AAE0C:
...
/* 800AAE50 000A6370  40 81 00 10 */	ble lbl_800AAE60
/* 800AAE54 000A6374  80 03 00 08 */	lwz r0, 8(r3)
/* 800AAE58 000A6378  7C 00 40 40 */	cmplw r0, r8
/* 800AAE5C 000A637C  41 81 00 0C */	bgt lbl_800AAE68
lbl_800AAE60:
...
/* 800AAEB0 000A63D0  41 82 00 10 */	beq lbl_800AAEC0
/* 800AAEB4 000A63D4  7C 84 3A 14 */	add r4, r4, r7
/* 800AAEB8 000A63D8  80 04 00 08 */	lwz r0, 8(r4)
/* 800AAEBC 000A63DC  48 00 00 08 */	b lbl_800AAEC4
lbl_800AAEC0:
