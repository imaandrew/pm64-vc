...
/* 800D3AC8 000CEFE8  48 00 00 AC */	b .L_800D3B74
.L_800D3ACC:
...
/* 800D3AF8 000CF018  40 82 00 1C */	bne .L_800D3B14
...
/* 800D3B10 000CF030  48 00 00 64 */	b .L_800D3B74
.L_800D3B14:
...
/* 800D3B38 000CF058  40 82 00 1C */	bne .L_800D3B54
...
/* 800D3B50 000CF070  48 00 00 24 */	b .L_800D3B74
.L_800D3B54:
...
/* 800D3B9C 000CF0BC  40 82 00 14 */	bne .L_800D3BB0
...
/* 800D3BAC 000CF0CC  48 00 00 14 */	b .L_800D3BC0
.L_800D3BB0:
...
/* 800D3C3C 000CF15C  48 00 01 A8 */	b .L_800D3DE4
.L_800D3C40:
...
/* 800D3C88 000CF1A8  41 80 FF E4 */	blt .L_800D3C6C
...
/* 800D3CA4 000CF1C4  48 00 01 2C */	b .L_800D3DD0
.L_800D3CA8:
...
/* 800D3CBC 000CF1DC  40 82 00 0C */	bne .L_800D3CC8
/* 800D3CC0 000CF1E0  3B 60 FF FF */	li r27, -1
/* 800D3CC4 000CF1E4  48 00 00 60 */	b .L_800D3D24
.L_800D3CC8:
...
/* 800D3D28 000CF248  40 80 00 0C */	bge .L_800D3D34
/* 800D3D2C 000CF24C  3B 40 00 03 */	li r26, 3
/* 800D3D30 000CF250  48 00 00 A8 */	b .L_800D3DD8
.L_800D3D34:
/* 800D3D34 000CF254  2C 1B 00 20 */	cmpwi r27, 0x20
/* 800D3D38 000CF258  40 82 00 98 */	bne .L_800D3DD0
...
/* 800D3D50 000CF270  40 82 00 0C */	bne .L_800D3D5C
/* 800D3D54 000CF274  3B 40 00 03 */	li r26, 3
/* 800D3D58 000CF278  48 00 00 80 */	b .L_800D3DD8
.L_800D3D5C:
...
/* 800D3D7C 000CF29C  48 00 00 3C */	b .L_800D3DB8
.L_800D3D80:
...
/* 800D3DBC 000CF2DC  40 81 00 0C */	ble .L_800D3DC8
/* 800D3DC0 000CF2E0  2C 1F 00 00 */	cmpwi r31, 0
/* 800D3DC4 000CF2E4  40 82 FF BC */	bne .L_800D3D80
.L_800D3DC8:
...
/* 800D3DD4 000CF2F4  40 82 FE D4 */	bne .L_800D3CA8
.L_800D3DD8:
