...
/* 800B7BFC 000B311C  40 81 00 0C */	ble lbl_800B7C08
/* 800B7C00 000B3120  38 60 00 00 */	li r3, 0
/* 800B7C04 000B3124  48 00 01 14 */	b lbl_800B7D18
lbl_800B7C08:
...
/* 800B7C30 000B3150  40 81 00 0C */	ble lbl_800B7C3C
/* 800B7C34 000B3154  38 60 00 00 */	li r3, 0
/* 800B7C38 000B3158  48 00 00 E0 */	b lbl_800B7D18
lbl_800B7C3C:
/* 800B7C3C 000B315C  7C 1C 40 50 */	subf r0, r28, r8
/* 800B7C40 000B3160  7F A0 DB 97 */	divwu. r29, r0, r27
/* 800B7C44 000B3164  40 82 00 0C */	bne lbl_800B7C50
/* 800B7C48 000B3168  38 60 00 00 */	li r3, 0
/* 800B7C4C 000B316C  48 00 00 CC */	b lbl_800B7D18
lbl_800B7C50:
...
/* 800B7C7C 000B319C  40 81 00 90 */	ble lbl_800B7D0C
/* 800B7C80 000B31A0  54 60 E8 FF */	rlwinm. r0, r3, 0x1d, 3, 0x1f
/* 800B7C84 000B31A4  7C 09 03 A6 */	mtctr r0
/* 800B7C88 000B31A8  41 82 00 70 */	beq lbl_800B7CF8
lbl_800B7C8C:
...
/* 800B7CEC 000B320C  42 00 FF A0 */	bdnz lbl_800B7C8C
/* 800B7CF0 000B3210  70 63 00 07 */	andi. r3, r3, 7
/* 800B7CF4 000B3214  41 82 00 18 */	beq lbl_800B7D0C
lbl_800B7CF8:
...
/* 800B7D08 000B3228  42 00 FF F4 */	bdnz lbl_800B7CFC
lbl_800B7D0C:
...
/* 800B7D50 000B3270  41 82 00 0C */	beq lbl_800B7D5C
...
/* 800B7D64 000B3284  41 82 00 0C */	beq lbl_800B7D70
...
/* 800B7D78 000B3298  41 82 00 0C */	beq lbl_800B7D84
...
/* 800B7D88 000B32A8  41 82 00 20 */	beq lbl_800B7DA8
...
/* 800B7D98 000B32B8  41 82 00 10 */	beq lbl_800B7DA8
...
/* 800B7E10 000B3330  41 82 00 0C */	beq lbl_800B7E1C
...
/* 800B7E58 000B3378  41 82 00 0C */	beq lbl_800B7E64
...
/* 800B7E68 000B3388  48 00 00 0C */	b lbl_800B7E74
lbl_800B7E6C:
