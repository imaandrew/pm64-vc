...
/* 8014C498 001479B8  40 82 00 20 */	bne lbl_8014C4B8
...
/* 8014C510 00147A30  40 82 00 18 */	bne lbl_8014C528
...
/* 8014C52C 00147A4C  40 82 00 18 */	bne lbl_8014C544
...
/* 8014C54C 00147A6C  40 82 00 68 */	bne lbl_8014C5B4
/* 8014C550 00147A70  2C 1F 00 00 */	cmpwi r31, 0
/* 8014C554 00147A74  40 82 00 18 */	bne lbl_8014C56C
...
/* 8014C570 00147A90  40 82 00 18 */	bne lbl_8014C588
...
/* 8014C5B0 00147AD0  48 00 00 38 */	b lbl_8014C5E8
lbl_8014C5B4:
...
/* 8014C630 00147B50  40 82 00 18 */	bne lbl_8014C648
...
/* 8014C64C 00147B6C  40 82 00 18 */	bne lbl_8014C664
...
/* 8014C674 00147B94  40 82 00 10 */	bne lbl_8014C684
/* 8014C678 00147B98  80 05 00 04 */	lwz r0, 4(r5)
/* 8014C67C 00147B9C  90 1D 00 00 */	stw r0, 0(r29)
/* 8014C680 00147BA0  48 00 00 10 */	b lbl_8014C690
lbl_8014C684:
...
/* 8014C698 00147BB8  40 82 00 10 */	bne lbl_8014C6A8
/* 8014C69C 00147BBC  80 05 00 00 */	lwz r0, 0(r5)
/* 8014C6A0 00147BC0  90 1D 00 04 */	stw r0, 4(r29)
/* 8014C6A4 00147BC4  48 00 00 10 */	b lbl_8014C6B4
lbl_8014C6A8:
...
/* 8014C708 00147C28  40 82 00 20 */	bne lbl_8014C728
...
/* 8014C72C 00147C4C  40 82 00 0C */	bne lbl_8014C738
/* 8014C730 00147C50  80 7E 00 00 */	lwz r3, 0(r30)
/* 8014C734 00147C54  48 00 00 10 */	b lbl_8014C744
lbl_8014C738:
...
/* 8014C784 00147CA4  40 82 00 20 */	bne lbl_8014C7A4
...
lbl_8014C7A4:
/* 8014C7A4 00147CC4  3F C0 80 1B */	lis r30, 0x801b
/* 8014C7A8 00147CC8  3F E0 80 1B */	lis r31, 0x801b
/* 8014C7AC 00147CCC  48 00 00 14 */	b lbl_8014C7C0
lbl_8014C7B0:
/* 8014C7B0 00147CD0  7C 1B E8 00 */	cmpw r27, r29
/* 8014C7B4 00147CD4  40 82 00 08 */	bne lbl_8014C7BC
/* 8014C7B8 00147CD8  48 00 00 50 */	b lbl_8014C808
lbl_8014C7BC:
/* 8014C7BC 00147CDC  3B BD 00 01 */	addi r29, r29, 1
lbl_8014C7C0:
/* 8014C7C0 00147CE0  2C 1A 00 00 */	cmpwi r26, 0
/* 8014C7C4 00147CE4  40 82 00 18 */	bne lbl_8014C7DC
/* 8014C7C8 00147CE8  38 7E BE 90 */	addi r3, r30, -16752
/* 8014C7CC 00147CEC  38 BF BE 9C */	addi r5, r31, -16740
...
/* 8014C7E0 00147D00  40 82 00 0C */	bne lbl_8014C7EC
/* 8014C7E4 00147D04  80 7A 00 00 */	lwz r3, 0(r26)
/* 8014C7E8 00147D08  48 00 00 10 */	b lbl_8014C7F8
lbl_8014C7EC:
...
/* 8014C800 00147D20  40 82 FF B0 */	bne lbl_8014C7B0
